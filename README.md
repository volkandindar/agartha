...
It is for SQLi attacks and you do not need to supply any inputs. It generates static, vendor-neutral, wordlist with escape characters for SQL language 'where' clause and it is applicable for Mysql, Mssql, Oracle, PostgreSQL, etc. 
