...
- **Authorization Matrix**: It creates an acccess role matrix based on user sessions and URL lists to help finding auhtorization/authentication related issues.
