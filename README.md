...
- **URL Addresses** the user (Http header/session owner) can visit: You can use 'SiteMap' generator feature or any other manual list. You need to provide visitable URL lists for all users.
