...
- You can click the “**Generate the Payload**s” button in the blue box above to create a classic wordlist, which can be used manually in Burp's Intruder or Repeater.
- Now, you also have the option to click the “**Generate payloads for BChecks**” button in the red box to generate the same payloads formatted in BCheck syntax, ready to be used in automated scans.
