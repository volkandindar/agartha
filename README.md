...
After clicking the "Generate payloads for BCheck" button, the BCheck code will be automatically copied to your clipboard. <br/>
Next, go to 'Extensions > BChecks > New > Blank' from the Burp Suite menu, and simply paste the generated code. <br>
