...
Your payloads are now integrated into a BCheck. You can either manually send/scan HTTP requests or initiate a Burp scan that incorporates BCheck controls to automatically test the injection payloads generated by the tool.
- **Manual scanning**: Right-click an HTTP request and select "Send to BChecks Editor".
