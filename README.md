...
- **URL Addresses** user can visit: You can use 'SiteMap' generator feature, manuel list or any sitemap tools. You may need to provide different URLs for different users.
